...
public:
    ...
    Complex operator*(const Complex& other) const {
        return Complex(_real * other._real - _imaginary * other._imaginary, _real * other._imaginary + other._real * _imaginary);
    }

    Complex operator/(const Complex& other) const {
        return Complex((_real * other._real + _imaginary * other._imaginary)/(other._real * other._real + other._imaginary * other._imaginary), (-_real * other._imaginary + other._real * _imaginary)/(other._real * other._real + other._imaginary * other._imaginary));
    }
